...
const model = getModel('gemma-4-12b-abliterated');
const reward = inferenceRewardSompi('gemma-4-12b-abliterated', 256);
check('token surcharge math: 2.0 base + 4*0.05', reward === 200000000 + 4 * 5000000);
